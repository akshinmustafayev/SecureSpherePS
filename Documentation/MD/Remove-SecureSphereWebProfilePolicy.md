...
```
Remove-SecureSphereWebProfilePolicy -PolicyName <String> [<CommonParameters>]
```
...
```powershell
Remove-SecureSphereWebProfilePolicy -PolicyName "policy 1"
```
...
[Official Documentation:](https://docs.imperva.com/bundle/v13.6-api-reference-guide/page/69914.htm)

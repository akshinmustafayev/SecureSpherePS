...
```
Remove-SecureSphereHTTPProtocolPolicy -PolicyName <String> [<CommonParameters>]
```
...
```powershell
Remove-SecureSphereHTTPProtocolPolicy -PolicyName "policy 1"
```
...
[Official Documentation:](https://docs.imperva.com/bundle/v13.6-api-reference-guide/page/70360.htm)

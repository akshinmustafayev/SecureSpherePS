function Edit-SecureSphereHTTPProtocolSignaturesPolicy {
    ...
    param (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateNotNullOrEmpty()] 
        [HTTPSignaturesPolicyApplyTo[]] $ApplyTo, 
    ...
    Begin {
        ...
        $ApiUrl = "$SecureSphereHost/SecureSphere/api/v1/conf/policies/security/httpProtocolSignaturesPolicies/$PolicyName"

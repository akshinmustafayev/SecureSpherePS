function Edit-SecureSphereURLRewriteGroup {
    ...
    Begin {
        ...
        if ($PSCmdlet.ParameterSetName -eq 'ByURLRewriteRule') {
            ...
            Write-DebugMessage "[$($MyInvocation.MyCommand.Name)] URLRewriteRulesJson was for ByURLRewriteRule: $($URLRewriteRulesJson)"
        }
        if ($PSCmdlet.ParameterSetName -eq 'ByURLRewriteRules') {
            $URLRewriteRulesJson = $URLRewriteRules | ConvertTo-Json
            Write-DebugMessage "[$($MyInvocation.MyCommand.Name)] URLRewriteRulesJson was for ByURLRewriteRules: $($URLRewriteRulesJson)"
        }
